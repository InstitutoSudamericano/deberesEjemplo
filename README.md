...
Son tres preguntas de opción múltiple basadas en el tema.

### Objetivo

El objetivo del Banco de Preguntas es desarrollar la capacidad de crear preguntas de evaluación que reflejen una comprensión profunda del tema. Este ejercicio ayuda a pensar críticamente sobre el contenido y a identificar los aspectos más importantes del material estudiado.
...
Cada tema tiene su propia actividad y está directamente relacionada con el contenido del tema.

### Objetivo

El objetivo de la Actividad del Tema es aplicar los conceptos aprendidos de manera práctica. Estas actividades permiten a los estudiantes profundizar .en el contenido del tema y desarrollar habilidades específicas relacionadas con el material estudiado.
...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| Video de YouTube | 1) El video debe mostrar la documentación.<br>2) **El video debe mostrar ejecución de la solución dentro de un editor de código (Visual Studio Code).**<br>3) En el video se explica el flujo de datos (lógica) de la solución.<br>4) En el video se explica la nueva sintaxis que aprendió.<br>5) La duración mínima es de 3 minutos, máxima de 5 minutos. | 60         |
| Documentación    | En la documentación debe desfragmentar el código de la solución por medio de preguntas acompañadas de sus respuestas. Estas preguntas deben apuntar a analizar la lógica y la sintaxis de manera similar a las evaluaciones de las unidades.                                                                                                                | 20         |
| Código           | La solución del ejercicio en la plataforma de Exercism. No puede tener comentarios que acompañen al código.                                                                                                                                                                                                                                                 | 20         |
